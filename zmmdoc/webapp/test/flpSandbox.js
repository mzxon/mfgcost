		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "자재 문서 생성",
									"targetURL": "#zmmdoczmmdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmdoczmmdoc-display": {
								"semanticObject": "zmmdoczmmdoc",
								"action": "display",
								"description": "MM Document Create",
								"title": "자재 문서 생성",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmdoc.zmmdoc",
									"url": sap.ui.require.toUrl("zmmdoc/zmmdoc")
								}
							}
						}
					}
