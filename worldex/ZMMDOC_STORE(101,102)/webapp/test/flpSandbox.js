		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 자재문서 생성",
									"targetURL": "#worldexzmmdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"worldexzmmdoc-display": {
								"semanticObject": "worldexzmmdoc",
								"action": "display",
								"description": "자재문서 생성",
								"title": "[MM] 자재문서 생성",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=worldexzmmdoc",
									"url": sap.ui.require.toUrl("worldexzmmdoc")
								}
							}
						}
					}
